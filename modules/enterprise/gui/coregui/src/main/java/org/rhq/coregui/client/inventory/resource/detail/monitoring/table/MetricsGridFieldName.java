...
public enum MetricsGridFieldName {
    ...
    SPARKLINE("sparkline"), METRIC_LABEL("label", CoreGUI.getMessages().common_title_name()), ALERT_COUNT("alertCount",
        ...
        .view_resource_monitor_table_max()), MIN_VALUE(MIN_KEY, CoreGUI.getMessages().view_resource_monitor_table_min()), AVG_VALUE(
        AVERAGE_KEY, CoreGUI.getMessages().view_resource_monitor_table_avg()), METRIC_DEF_ID("defId"), METRIC_SCHEDULE_ID(
        "schedId"), METRIC_UNITS("units"), METRIC_NAME("name"), RESOURCE_GROUP_ID("resourceGroupId"),
    RESOURCE_ID("resourceId"), LIVE_VALUE("live", CoreGUI.getMessages().view_resource_monitor_table_last());
